...
const AddProblemStatement = lazy(() =>
  import("./scenes/CommitteeScenes/AddProblemStatement/AddProblemStatement")
);
const ViewProblemStatements = lazy(() =>
  import("./scenes/CommitteeScenes/ViewProblemStatements/ViewProblemStatements")
);
const ViewSubmissionResults = lazy(() =>
  import("./scenes/CommitteeScenes/ViewSubmissionResults")
);
const AddSubmission = lazy(() =>
  import("./scenes/CommitteeScenes/AddSubmission")
);
const ViewSubmissions = lazy(() =>
  import("./scenes/CommitteeScenes/ViewSubmissions")
);
...
export const committeeRoutes = (isConvenor) => (
  ...
  >
    ...
    />
    <Route
      path="/ViewProblemStatements"
      element={
        <Suspense fallback={<div></div>}>
          <ViewProblemStatements />
        </Suspense>
      }
    />
    <Route
      path="/ViewSubmissionResults"
      element={
        <Suspense fallback={<div></div>}>
          <ViewSubmissionResults />
        </Suspense>
      }
    />
    <Route
